...
function RenderData(props) {
  const fetchData = () => {
      let presetData = require("./test_18mar.json")
      if (props.saved==undefined) {
          // pass
          }
        else if (presetData.content[[presetData.content.length - 1]].theme!='Saved') {
    ...
    // presetData.content = presetData.content.filter((value) => value != undefined);
